...
$(KERNEL_CONFIG): $(KERNEL_OUT)
	$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) $(KERNEL_DEFCONFIG)
	$(hide) if [ ! -z "$(KERNEL_CONFIG_OVERRIDE)" ]; then \
			echo "Overriding kernel config with '$(KERNEL_CONFIG_OVERRIDE)'"; \
			echo $(KERNEL_CONFIG_OVERRIDE) >> $(KERNEL_OUT)/.config; \
			$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) oldconfig; fi
...
$(TARGET_PREBUILT_INT_KERNEL_IMAGE): $(KERNEL_OUT) $(KERNEL_HEADERS_INSTALL)
	...
	$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) $(KERNEL_CFLAGS) modules
	$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) INSTALL_MOD_PATH=$(BUILD_ROOT_LOC)../$(KERNEL_MODULES_INSTALL) INSTALL_MOD_STRIP=1 $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) modules_install
	$(mv-modules)
	$(clean-module-folder)
...
$(TARGET_PREBUILT_INT_KERNEL): $(TARGET_PREBUILT_INT_KERNEL_IMAGE)
	...
	$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) $(KERNEL_CFLAGS)
else
...
$(KERNEL_DEBUGFS):
	...
	OUT_DIR=$(KERNEL_OUT) \
	ARCH=$(KERNEL_ARCH) \
	CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) \
...
$(KERNEL_HEADERS_INSTALL): $(KERNEL_OUT)
	$(hide) if [ ! -z "$(KERNEL_HEADER_DEFCONFIG)" ]; then \
			...
			$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_HEADER_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) $(KERNEL_HEADER_DEFCONFIG) && \
			$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_HEADER_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) headers_install && \
	...
	$(hide) if [ "$(KERNEL_HEADER_DEFCONFIG)" != "$(KERNEL_DEFCONFIG)" ]; then \
			...
			rm -f $(BUILD_ROOT_LOC)$(KERNEL_CONFIG); \
			$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) $(KERNEL_DEFCONFIG); fi
	$(hide) if [ ! -z "$(KERNEL_CONFIG_OVERRIDE)" ]; then \
			echo "Overriding kernel config with '$(KERNEL_CONFIG_OVERRIDE)'"; \
			echo $(KERNEL_CONFIG_OVERRIDE) >> $(KERNEL_OUT)/.config; \
			$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) oldconfig; fi
...
kerneltags: $(KERNEL_OUT) $(KERNEL_CONFIG)
	$(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) tags

.PHONY: kernelconfig
kernelconfig: $(KERNEL_OUT) $(KERNEL_CONFIG)
	env KCONFIG_NOTIMESTAMP=true \
	     $(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) menuconfig
	env KCONFIG_NOTIMESTAMP=true \
	     $(PATH_OVERRIDE) $(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE_ARM32=$(KERNEL_CROSS_COMPILE_ARM32) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(cc) savedefconfig
